...
export default function EditExamPage() {
    ...
    const loadExam = async () => {
        try {
            ...
            // If there's already a distribution, load it
            if (exam.subjectDistribution) {
                const dist: Record<string, number> = {};
                exam.subjectDistribution.forEach(d => {
                    dist[d.subjectId] = d.count;
                });
            ...
            toast.error("Шалгалтын мэдээллийг ачаалахад алдаа гарлаа");
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.error("Шалгалт шинэчлэхэд алдаа гарлаа");
        } finally {
            setSaving(false);
        }
    };
        ...
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                    <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Шалгалт засах</h1>
