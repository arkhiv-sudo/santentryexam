  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-8 text-center border border-emerald-100">
        ...
        <h1 className="text-xl font-black text-slate-900 mb-2">Багшийн хэсэгт алдаа гарлаа</h1>
        ...
        <div className="flex gap-2 justify-center mt-6">
          <button onClick={() => reset()} className="inline-flex items-center gap-1.5 bg-emerald-600 text-white px-4 py-2 rounded-xl font-bold text-sm hover:bg-emerald-700">
            <RefreshCw className="w-4 h-4" /> Дахин оролдох
          </button>
          <button onClick={() => router.push("/teacher")} className="inline-flex items-center gap-1.5 bg-slate-100 text-slate-700 px-4 py-2 rounded-xl font-bold text-sm hover:bg-slate-200">
